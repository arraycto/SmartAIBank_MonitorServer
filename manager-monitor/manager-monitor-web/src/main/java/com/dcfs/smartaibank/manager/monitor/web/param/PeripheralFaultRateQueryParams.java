 ...
 *
 * @author wangjzm
 * @data 2019/07/23 13:21
 * @since 1.0.0
 */
@Api(value = "PeripheralFaultRateQueryParams", description = "监控报表-外设故障率查询参数")
@Getter
@Setter
@NoArgsConstructor
@ToString
public class PeripheralFaultRateQueryParams {
    @ApiModelProperty(value = "设备类型", required = true)
    @NotEmpty(message = "{deviceType.not.empty}")
    private String devClassKey;

    @ApiModelProperty(value = "设备型号-（外设故障详情中使用）", required = false)
    ...
    @ApiModelProperty(value = "是否为营业兼管理机构")
