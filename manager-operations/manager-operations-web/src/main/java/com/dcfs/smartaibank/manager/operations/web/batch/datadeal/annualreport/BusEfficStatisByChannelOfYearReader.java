...
@Slf4j
@StepScope
public class BusEfficStatisByChannelOfYearReader extends AbstractTasklet {
	@Autowired
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		log.info("业务效率按照机构统计-->年统计，传入参数：[year,dateType]=[{},{}]",
			year, Constants.YEAR);
		try {
			operationDataStatsDao.busEffic(year, Constants.YEAR, "");
		} catch (Exception e) {
			log.error("业务效率按照机构统计-->年统计，发生异常", e);
		}
