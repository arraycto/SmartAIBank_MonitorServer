...
@Slf4j
@StepScope
public class CustRoutesOfMonthReader extends AbstractTasklet {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		log.info("客户动线数据-->月统计，传入参数：[dateType,monthStr,quarter]=[{},{},{}]",
			Constants.MONTH, monthStr, quarter);
		try {
			operationDataStatsDao.custRouteStats(Constants.MONTH, monthStr, quarter);
		} catch (Exception e) {
			log.error("客户动线数据月统计发生异常", e);
		}
