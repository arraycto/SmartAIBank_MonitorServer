...
@Slf4j
@StepScope
public class CustRoutesOfQuarterReader extends AbstractTasklet {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		log.info("客户动线数据-->季统计，传入参数：[dateType,quarterStr,year]=[{},{},{}]",
			Constant.QUARTER, quarterStr, year);
		try {
			operationDataStatsDao.custRouteStats(Constant.QUARTER, quarterStr, year);
		} catch (Exception e) {
			log.error("客户动线数据季统计发生异常", e);
		}
