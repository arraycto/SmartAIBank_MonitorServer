...
@Slf4j
@StepScope
public class HallDataStaticOfQuarterReader extends AbstractTasklet {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
		...
		log.info("厅堂数据按照机构统计-->季统计，传入参数：[dateType,quarterStr,year]=[{},{},{}]",
			Constant.QUARTER, quarterStr, year);
		try {
			operationDataStatsDao.hallMarketStats(Constant.QUARTER, quarterStr, year);
		} catch (Exception e) {
			log.error("厅堂机构数据季统计发生异常", e);
		}
